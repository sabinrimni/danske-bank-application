...
var PersonRouter = /** @class */ (function () {
    /**
    ...
    function PersonRouter() {
        ...
        this.getPerson = function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                if (input) {
                    result = StorageManager_1["default"].getPerson(input);
                    if (result)
                        res.send(result);
                    else
                        res.sendStatus(404);
